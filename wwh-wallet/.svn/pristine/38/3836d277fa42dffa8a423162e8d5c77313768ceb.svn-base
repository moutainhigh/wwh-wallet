package com.wwh.pay.weixin.resp;
/** 
 * 统一下单返回参数 
 * @author Y 
 * 
...
public class UnifiedOrderRespose {
	  private String return_code;             //返回状态码  
		...
		public String toString() {
			return "UnifiedOrderRespose [return_code=" + return_code + ", return_msg=" + return_msg + ", appid=" + appid
					...
					+ err_code_des + ", trade_type=" + trade_type + ", prepay_id=" + prepay_id + ", code_url="
					+ code_url + "]";
		}
