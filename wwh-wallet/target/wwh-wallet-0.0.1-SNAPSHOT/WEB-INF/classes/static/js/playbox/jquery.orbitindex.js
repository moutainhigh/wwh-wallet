(function (c) {
    var g = {
        ...
        init: function (a, b) {
            ...
            this.$element.bind("orbit.goto",
            function (a, b) {
                f.shift(b)
            });
            this.$element.bind("orbit.start",
            function () {
                f.startClock()
            });
            this.$element.bind("orbit.stop",
            function () {
                f.stopClock()
            });
            d = this.$slides.filter("img");
            0 === d.length ? this.loaded() : d.bind("imageready",
            function () {
                e += 1;
                e === d.length && f.loaded()
            })
        ...
        loaded: function () {
            this.$element.addClass("orbit").width("720px").height("340px");
        ...
        setDimentionsFromLargestSlide: function () {
            ...
            this.$slides.each(function () {
                ...
                if (b > a.$element.height()) a.$element.add(a.$wrapper).height(b),
        ...
        updateOptionsIfOnlyOneSlide: function () {
            if (1 === this.$slides.length) this.options.directionalNav = !1,
        ...
        rotateTimer: function () {
            ...
            if (360 < this.degrees) this.$rotator.removeClass("move"),
            this.$mask.removeClass("move"),
            this.degrees = 0,
            this.$element.trigger("orbit.next")
        },
        stopClock: function () {
            if (this.options.timer) this.timerRunning = !1,
        ...
        setCaption: function () {
            var a = this.currentSlide().attr("data-caption"),
            b;
        ...
        addBullet: function (a, b) {
            ...
            e,
            f = this;
            this.options.bulletThumbs && (e = c(b).attr("data-thumb")) && d.addClass("has-thumb").css({
                background: "url(" + this.options.bulletThumbLocation + e + ") no-repeat"
            });
        ...
        shift: function (a) {
            ...
            if (!this.locked) {
                ...
                if ("next" == a) {
                    ...
                    if (this.activeSlide--, 0 > this.activeSlide) this.activeSlide = this.numberSlides - 1
                } else this.activeSlide = a,
                this.prevActiveSlide < this.activeSlide ? b = "next" : this.prevActiveSlide > this.activeSlide && (b = "prev");
                ...
                this.options.animationSpeed, this.resetAndUnlock), "prev" == b && this.$slides.eq(this.activeSlide).css({
                    left: -this.orbitWidth,
                    "z-index": 3
                }).animate({
                    left: 0
                ...
                this.options.animationSpeed, this.resetAndUnlock), "next" == b && this.$slides.eq(this.activeSlide).css({
                    top: -this.orbitHeight,
                    "z-index": 3
                }).animate({
                    top: 0
                ...
                this.options.animationSpeed)), "prev" == b && (this.$slides.eq(this.activeSlide).css({
                    left: -this.orbitWidth,
                    "z-index": 3
                }).animate({
                    left: 0
