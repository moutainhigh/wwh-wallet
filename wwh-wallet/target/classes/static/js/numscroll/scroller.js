...
;(function(parent){
	...
	var Scroller=(function(){
		...
		function ScrollerImpl(props){
			...
			this.scrollPane.className = "scroller-table-div";
			this.table=null;
			this.beginNum=0;
			this.endNum=0;
			this.css=null;
				...
				for(var i=0;i<maxLength;++i){
					...
					if(this.props.separatorType!=Scroller.SEPARATOR.NONE&&
					  (i+separatorCount)%this.props.separatorType===0&&(i+1)<maxLength){
						...
						div.setAttribute("style","height:"+(this.props.amount + 10)+"px;line-height:"+this.props.amount+"px;left:0px;top:0px;vertical-align:middle;line-height:58px;");
