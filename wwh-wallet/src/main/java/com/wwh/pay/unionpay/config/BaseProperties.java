package com.wwh.pay.unionpay.config;
...
public class BaseProperties {
	...
	private static Logger logger = LogManager.getLogger(BaseProperties.class);
	...
	public static String frontUrl = "http://1k50m07526.51mypc.cn/wwh-wallet/unionpay/frontRcvResponse";

	// 后台服务对应的写法参照 BackRcvResponse.java
	public static String backUrl = "http://1k50m07526.51mypc.cn/wwh-wallet/unionpay/BackRcvResponse";// 受理方和发卡方自选填写的域[O]--后台通知地址
	...
	public static List<Map> parseZMFile(String filePath) {
		int lengthArray[] = { 3, 11, 11, 6, 10, 19, 12, 4, 2, 21, 2, 32, 2, 6, 10, 13, 13, 4, 15, 2, 2, 6, 2, 4, 32, 1, 21, 15, 1, 15, 32, 13, 13, 8, 32, 13,
				13, 12, 2, 1, 131 };
